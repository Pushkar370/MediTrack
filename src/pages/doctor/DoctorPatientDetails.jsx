...
import { patients, consultations, prescriptions, medicalRecords } from "../../data/mockData";
...
export default function DoctorPatientDetails() {
  ...
  const consults = (consultations || []).filter((c) => c.patientId === patient.id);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        {tab === "history" && <Timeline patient={patient} />}
        ...
        {tab === "treatment" && (
          <div className="space-y-3">
            ...
            {consults.length === 0 && <EmptyState icon={Activity} title="No treatment history" />}
          </div>
        )}
      </div>
    </div>
